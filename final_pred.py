...
class Application:
    ...
    def __init__(self):
        ...
        self.root = tk.Tk()
        self.root.title("AI FOR AUGMENTATIVE AND ALTERNATIVE COMMUNICATION")
        ...
        self.T.config(text="AI FOR AUGMENTATIVE AND ALTERNATIVE COMMUNICATION", font=("Courier", 30, "bold"))
        ...
        self.T1.config(text="Letter :", font=("Courier", 30, "bold"))
...
# THESE LINES START THE APP - MUST BE AT THE BOTTOM
